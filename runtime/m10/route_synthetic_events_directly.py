...
def main() -> None:
    ...
    # This assignment is unique to the completed blank-document toolbar stage.
    # Keep the marker insertion independent of the exact neighbouring fprintf
    # formatting generated by the locked M10 source.
    stage_anchor = "            g_m10_synthetic_stage = 1u;\n"
    stage_replacement = (
        stage_anchor
        + "            fprintf(stderr,\n"
    ...
    text = replace_once(
        text, stage_anchor, stage_replacement,
        "synchronous staged-event stage assignment",
    )
