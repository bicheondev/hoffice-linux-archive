...
void *build_initial_stack(const char *guest_path,
    ...
    static const char env_preload[] =
        "LD_PRELOAD=/opt/hrt/lib/libhrt_window_probe.so";
    static const char env_library[] =
        "LD_LIBRARY_PATH=/opt/hrt/lib:"
    ...
    uintptr_t environment[] = {
        push_bytes(&cursor, floor, env_preload, sizeof(env_preload)),
