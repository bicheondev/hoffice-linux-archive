...
void *build_initial_stack(const char *guest_path,
    ...
    static const char env_library[] =
        "LD_LIBRARY_PATH=/opt/hrt/qt/plugins/platforms:"
    ...
    static const char env_platform[] = "QT_QPA_PLATFORM=hrtmac";
    static const char env_plugin_path[] =
        "QT_PLUGIN_PATH=/opt/hrt/qt/plugins:"
        "/opt/hnc/hoffice11/Bin/qt/plugins";
    static const char env_platform_plugin_path[] =
        "QT_QPA_PLATFORM_PLUGIN_PATH=/opt/hrt/qt/plugins/platforms";
